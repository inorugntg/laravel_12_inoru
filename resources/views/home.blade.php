...
@section('content')
    ...
    <section class="jumbotron text-center">
        <img src="https://th.bing.com/th/id/OIP.Rd_9NmaqgzvycxtsG4hFIgAAAA?pid=ImgDet&w=474&h=417&rs=1;height=300"
            alt="aaa" width="200" class=" rounded-circle img-thumbnail">
        <h1 class="display-4">Inoru Akhmad</h1>
        <p class="lead">12 RPL 1| Absen 30</p>
    </section>
